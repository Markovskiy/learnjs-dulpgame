...
/***/ function(module, exports, __webpack_require__) {
	...
	var startButton = document.querySelector('.btn__start');
	...
	var Game = function () {
	  ...
	  */
	  ...
	  function Game(level) {
	    ...
	    this.userInterface = new _Interface2.default();
	    this.circle = new _Circle2.default(this.circleOptions);
	  }
	  ...
	  _createClass(Game, [{
	    ...
	    value: function gameLoop() {
	      var time = Date.now();
	      var delta = time - this._lastTime; // сколько прошло с последнего обновления;
	...
	var Circle = function () {
		...
		_createClass(Circle, [{
			...
			value: function _getRotationDegs() {
				...
				this._rotationDeg = 0;
				for (var i = 0; i < this.level.colorCount; i++) {
			...
			key: '_spin',
			value: function _spin(speed) {
				var _this = this;

				this.spinDegree = 0;
				setInterval(function () {
					_this.el.style.transform = 'rotate(' + _this.spinDegree + 'deg)';
					_this.spinDegree += 1;
					if (_this.spinDegree === 360) {
						_this.spinDegree = 0;
					}
				}, 50 - speed);
			}
			...
			key: 'getHitSector',
			value: function getHitSector(x, y) {
